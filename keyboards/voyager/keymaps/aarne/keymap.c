...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME] = LAYOUT_voyager(
    ...
    KC_TAB,         _______,        _______,        KC_E,           _______,        _______,               _______,        _______,        KC_I,           _______,        _______,         _______,
    KC_LSFT,        KC_A,           KC_S,           KC_D,           KC_F,           _______,               _______,        KC_J,           KC_K,           KC_L,           KC_SCLN,         _______,
    KC_LCTL,        _______,        _______,        KC_C,           _______,        _______,               _______,        KC_M,           _______,        _______,        _______,         _______,
  ...
  [_ADJ] = LAYOUT_voyager(
    ...
    XXXXXXX,        KC_F9,          KC_F10,         KC_F11,         KC_F12,         XXXXXXX,               XXXXXXX,        HYPR(KC_G),     XXXXXXX,        XXXXXXX,        VOL_DN,          VOL_UP,
                                                                      KC_ACL0,         KC_ACL2,         KC_BTN1,        KC_BTN2
  ),
